    ...
    def fit(self, X, y):
        ...
        with self.__graph.as_default():
            ...
            with self.__sess.as_default():
                ...
                convergence_count = 0
                # min -> max
                top_score = [-99999 + i for i in range(self.__tracking_top_n)]
                for batch in batches:
                    ...
                    if self.__evaluate:
                        if current_step % self.__evaluate_every == 0:
                            ...
                            print("")
                            if BOTscore >= top_score[0]:
                                for i, v in reversed(list(enumerate(top_score))):
                                    if BOTscore >= v:
                                        convergence_count = 0
                                        if i > 0:
                                            ...
                                            top_score[i] = BOTscore
                                        checkpoint_prefix = os.path.join(self.__out_dir, '{}_N_{:.4}_{:.4}'.format(current_step, current_loss, BOTscore))
